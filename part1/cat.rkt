...
; HAPPY CAT
;==================================================================================
; A cat is walking randomly on the screen.
; It has a happiness level (there is a gauge on the screen).
; The cat gets tired from all the walking and its happiness decreases.
; The cat's speed depends on its happiness level. It moves fast when happy.
; If you press button "up" on the keyboard, you feed the cat.
; (A picture of food appears on the screen for a few moments.)
; If you move your mouse cursor over the cat, you stroke it.
; (The cat begins moving slowly around the cursor.)
...
(define FOOD (bitmap "images/food.png"))
