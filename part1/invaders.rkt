...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname space) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
;==================================================================================
; SPACE INVADERS
;==================================================================================
...
(define WIDTH 400)
(define HEIGHT 600)
(define CLOUD (bitmap "images/cloud.png"))
(define TREE (bitmap "images/tree.png"))
...
; > Missile launcher
(define LAUNCHER (bitmap "images/car.png"))
...
; > Missile
(define MISSILE (bitmap "images/missile.png"))
(define MSL-VEL -500)
