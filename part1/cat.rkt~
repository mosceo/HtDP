...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname cat) (read-case-sensitive #t) (teachpacks ((lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp") (lib "batch-io.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp") (lib "batch-io.rkt" "teachpack" "2htdp")) #f)))
;==================================================================================
; ABOUT THE PROGRAM
;==================================================================================
; This is a world program that shows a cat moving randomly on the screen.
; It has a certain happiness level (you can see a gauge on the screen).
; The cat gets tired from all the walking and its happiness decreases.
; When it becomes less happy it slows down.
; If you press button "up" on the keyboard, you feed the cat.
; If you move your mouse cursor over the cat, you stroke it.
; Feeding and stroking increases the cat's happiness level.
...
; 'food' - is a non-negative number, meaning for how many ticks the cat
;          will remain in a special state after it has been stroked
